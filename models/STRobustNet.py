...
from models.RRGM import RRGM

from models.multi_scale_encoder_decoder import multi_scale_encoder_decoder
from einops import rearrange
import numpy as np
from models.DRPH import *
...
class STRobustNet(nn.Module):
    def __init__(self, cfg):
        ...
        self.DRPH = DRPH(cfg.num_queries)
